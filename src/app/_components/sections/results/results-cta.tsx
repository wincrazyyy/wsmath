    ...
    <section className="relative mt-8">
      ...
      <div className="relative rounded-2xl p-[1.5px]">
        ...
        >
          <div
            className={[
              "absolute -inset-12 rounded-[28px]",
              "bg-[conic-gradient(from_0deg,rgba(99,102,241,0.95),rgba(168,85,247,0.95),rgba(56,189,248,0.95),rgba(99,102,241,0.95))]",
                ...
                <div className="pointer-events-none absolute inset-x-4 bottom-3 z-10 sm:bottom-4">
                  <div className="pointer-events-auto relative mx-auto w-full max-w-[560px] rounded-2xl border border-white/60 bg-white/75 px-4 py-3 shadow-lg backdrop-blur sm:px-5 sm:py-4">
                    ...
                    <div className="relative flex flex-col items-center text-center">
                      ...
                      {resultsCta.note && (
                        <p className="mt-2 text-xs text-neutral-600">{resultsCta.note}</p>
                      )}
                    </div>
                  </div>
                </div>
