        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-neutral-900">{footer.brand.name}</p>
            ...
            {/* Back to top (subtle + doesn’t fight for space) */}
            <a
              href={footer.brand.backToTop.href}
              className="mt-3 inline-flex items-center gap-1 text-xs font-semibold text-neutral-700 transition hover:text-neutral-900"
            >
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 flex items-center gap-2">
                ...
                >
                  <span
                    aria-hidden
                    className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-indigo-50 text-indigo-700"
                  >
                ...
                >
                  <span
                    aria-hidden
                    className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-violet-50 text-violet-700"
                  >
